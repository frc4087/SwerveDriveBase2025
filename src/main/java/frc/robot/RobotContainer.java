...
import frc.robot.subsystems.teleop.TeleopController;
import frc.robot.subsystems.teleop.TeleopControllerImpl;
...
public class RobotContainer {
    ...
    public final TeleopController teleopController = TeleopControllerImpl.initialize();
