...
public class RobotContainer {
        ...
        private double MaxSpeed = config.TunerConstants.getKSpeedAt12Volts().in(MetersPerSecond); // kSpeedAt12Volts
                                                                                                  // desired
                                                                                                  // top speed
        ...
        ////////// AutonomousControllerImpl.initialize(config, drivetrain,
        // frankenArm, rollsRUs);
        //////////
